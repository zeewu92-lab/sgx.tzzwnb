export const STRINGS = {
  'zh-TW': {
    ...
    currentLocation: '當前時區', setAsCurrent: '點一下設為目前位置', tapToUnset: '再點一下取消設定',
...
© 2026 時光線`,
  ...
  en: {
    ...
    currentLocation: 'Current timezone', setAsCurrent: 'Tap to set as current location', tapToUnset: 'Tap again to unset',
...
© 2026 時光線`,
  ...
  ja: {
    ...
    currentLocation: '現在のタイムゾーン', setAsCurrent: 'タップして現在地に設定', tapToUnset: 'もう一度タップで解除',
...
© 2026 時光線`,
  ...
  ko: {
    ...
    currentLocation: '현재 시간대', setAsCurrent: '탭하여 현재 위치로 설정', tapToUnset: '다시 탭하면 해제',
